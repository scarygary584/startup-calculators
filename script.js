...
radioConstruction: {
  ...
  bathroomRemodel: {
    ...
    results: [["monthlyRevenue", "Monthly remodeling revenue", "money"], ["monthlyExpenses", "Monthly costs", "money"], ["monthlyProfit", "Estimated monthly profit", "money", true], ["profitPerProject", "Profit per project", "money"], ["profitMargin", "Profit margin percent", "number"], ["breakEvenProjects", "Break-even projects per month", "number"], ["paybackMonths", "Startup payback in months", "number"]],
