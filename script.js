...
const calculators = {
  striping: {
    ...
    results: [
      ...
      ["totalRevenue", "Total revenue", "money", true],
      ["profit", "Estimated profit before overhead", "money"],
  ...
  bounce: {
    ...
    results: [
      ["monthlyRevenue", "Monthly revenue", "money", true],
      ["variableCosts", "Monthly variable costs", "money"],
      ["profitBeforePayback", "Monthly profit before equipment payback", "money"],
  ...
  vending: {
    ...
    results: [
      ...
      ["monthlyGross", "Monthly gross profit", "money", true],
      ["monthlyNet", "Monthly net profit", "money"],
  ...
  golfChallenge: {
    ...
    results: [
      ...
      ["monthlyBucketRevenue", "Total monthly bucket revenue", "money", true],
      ["prizePayoutCost", "Prize payout cost", "money"],
      ["operatingCosts", "Total monthly operating costs", "money"],
      ["monthlyProfit", "Estimated monthly profit before taxes", "money"],
  ...
  mobileSauna: {
    ...
    results: [
      ...
      ["monthlyProfit", "Monthly profit before overhead", "money"],
  ...
  christmasLights: {
    ...
    results: [
      ["seasonRevenue", "Estimated season revenue", "money", true],
      ["seasonCosts", "Estimated season costs", "money"],
      ["seasonProfit", "Estimated season profit before overhead", "money"],
  ...
  coldCake: {
    ...
    results: [
      ...
      ["revenue", "Estimated revenue", "money", true],
      ["profit", "Estimated profit after campaign cost", "money"],
  ...
  gutterCleaning: {
    ...
    results: [
      ["monthlyRevenue", "Monthly route revenue", "money", true],
      ["monthlyCosts", "Monthly costs", "money"],
      ["monthlyProfit", "Estimated monthly profit before taxes", "money"],
  ...
  fenceStaining: {
    ...
    results: [
      ...
      ["profitPerJob", "Estimated profit per job", "money", true],
...
radioConstruction: {
  ...
  parkingLotPizza: {
    ...
    results: [
      ["monthlyRevenue", "Monthly pizza revenue", "money", true],
  ...
  b2bStump: {
    ...
    results: [
      ["monthlyRevenue", "Monthly B2B revenue", "money", true],
  ...
  porchDecor: {
    ...
    results: [
      ["seasonRevenue", "Season revenue", "money", true],
  ...
  washerDryerRental: {
    ...
    results: [
      ["monthlyRevenue", "Monthly recurring revenue", "money", true],
  ...
  coilCleaning: {
    ...
    results: [
      ["monthlyRevenue", "Monthly coil cleaning revenue", "money", true],
  ...
  dumpTrailer: {
    ...
    results: [["monthlyRevenue", "Monthly rental revenue", "money", true], ["monthlyExpenses", "Monthly operating expenses", "money"], ["monthlyProfit", "Estimated monthly profit", "money"], ["profitPerRental", "Profit per rental", "money"], ["profitMargin", "Profit margin percent", "number"], ["breakEvenRentals", "Break-even rentals per month", "number"], ["paybackMonths", "Startup payback in months", "number"]],
  ...
  sprinklerInstall: {
    ...
    results: [["monthlyRevenue", "Total monthly revenue", "money", true], ["monthlyExpenses", "Monthly costs", "money"], ["monthlyProfit", "Estimated monthly profit", "money"], ["profitPerInstall", "Profit per installation", "money"], ["profitMargin", "Profit margin percent", "number"], ["breakEvenInstalls", "Break-even installs per month", "number"], ["paybackMonths", "Startup payback in months", "number"]],
  ...
  gutterInstall: {
    ...
    results: [["monthlyRevenue", "Monthly installation revenue", "money", true], ["monthlyExpenses", "Monthly costs", "money"], ["monthlyProfit", "Estimated monthly profit", "money"], ["profitPerJob", "Profit per job", "money"], ["profitMargin", "Profit margin percent", "number"], ["breakEvenJobs", "Break-even jobs per month", "number"], ["paybackMonths", "Startup payback in months", "number"]],
  ...
  shedInstall: {
    ...
    results: [["monthlyRevenue", "Monthly shed revenue", "money", true], ["monthlyExpenses", "Monthly costs", "money"], ["monthlyProfit", "Estimated monthly profit", "money"], ["profitPerJob", "Profit per installation", "money"], ["profitMargin", "Profit margin percent", "number"], ["breakEvenJobs", "Break-even jobs per month", "number"], ["paybackMonths", "Startup payback in months", "number"]],
  ...
  aquariumInstall: {
    ...
    results: [["monthlyRevenue", "Total monthly revenue", "money", true], ["monthlyExpenses", "Monthly costs", "money"], ["monthlyProfit", "Estimated monthly profit", "money"], ["profitPerProject", "Profit per project before fixed overhead", "money"], ["maintenanceProfit", "Monthly maintenance contribution", "money"], ["profitMargin", "Profit margin percent", "number"], ["paybackMonths", "Startup payback in months", "number"]],
  ...
  grillCleaning: {
    ...
    results: [
      ["monthlyRevenue", "Monthly grill cleaning revenue", "money", true],
